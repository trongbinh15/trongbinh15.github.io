                ...
                <div className={styled.innerWidth}>
                    <div className={styled.content}>
                        ...
                        <div className={styled.skills}>
                            <ProgressBar {...{ name: "Javascript", value: "0.65", color: variables.primaryColor, className: styled.bar }} >
                            </ProgressBar>
                            <ProgressBar {...{ name: "C#", value: "0.65", color: variables.primaryColor, className: styled.bar }}>
                            </ProgressBar>
                            <ProgressBar {...{ name: "React", value: "0.69", color: variables.primaryColor, className: styled.bar }}>
                            </ProgressBar>
                        </div>
                    </div>
                </div>
